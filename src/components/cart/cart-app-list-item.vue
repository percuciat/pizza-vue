<template>
    <li class="cart__item">
        ...
        <div class="cart__item-remove" @click="removeItems(elCart[0].idP)">
...
<script>
  ...
  export default defineComponent({
    ...
    props: {
     ...
     computed: {
        sumCollection() {
          return this.elCart.reduce((ac, el) => ac += el.price, 0)
        }
     },
    methods: {
      plusProduct(newProduct){
        this.$store.dispatch('cart/plusProduct', {newProduct})
      },
      removeItems(id) {
